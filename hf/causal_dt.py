...
CAUSAL_DECISION_TRANSFORMER_START_DOCSTRING = r"""
    This model is a PyTorch [torch.nn.Module](https://pytorch.org/docs/stable/nn.html#torch.nn.Module) sub-class. Use
    it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
    behavior.
    Parameters:
        config ([`~CausalDecisionTransformerConfig`]): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the
            configuration. Check out the [`~PreTrainedModel.from_pretrained`] method to load the model weights.
"""


CAUSAL_DECISION_TRANSFORMER_INPUTS_DOCSTRING = r"""
    Args:
        ...
        causal_structures (`torch.FloatTensor` of shape `(batch_size, episode_length, causal_structure_dim)`):
...
_CONFIG_FOR_DOC = "CausalDecisionTransformerConfig"


@add_start_docstrings("The Causal Decision Transformer Model v1", CAUSAL_DECISION_TRANSFORMER_START_DOCSTRING)
class CausalDecisionTransformerModelV1(DecisionTransformerPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(CAUSAL_DECISION_TRANSFORMER_INPUTS_DOCSTRING.format("batch_size, sequence_length"))
...
@add_start_docstrings("The Causal Decision Transformer Model V2", CAUSAL_DECISION_TRANSFORMER_START_DOCSTRING)
